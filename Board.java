...
public class Board {
    ...
    public static final int NO_PLAYER = 0; //порожня комірка
    public static final int PLAYER_X = 1; //комп'ютер
    public static final int PLAYER_O = 2; //користувач
    private int[][] board = new int[3][3]; //дошка
